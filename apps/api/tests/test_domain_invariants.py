...
def test_invariant_submitted_implies_locked(db: Session, factory):
...
def test_invariant_submit_creates_audit_log(db: Session, factory):
...
def test_invariant_duplicate_submit_blocked(db: Session, factory):
