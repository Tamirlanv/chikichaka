...
MSG_DIRECT_NOT_VIDEO = "По ссылке не обнаружен видеофайл. Укажите прямую ссылку на видео (video/*) или YouTube / Google Drive."
MSG_UNSUPPORTED_HOST = "Для презентации поддерживаются YouTube, Google Drive (файл с видео) или прямая ссылка на видеофайл."
...
def evaluate_presentation_video(
    *,
    ...
    # --- Vimeo / Dropbox / OneDrive / other clouds ---
    if classification.provider in {"vimeo", "dropbox", "onedrive"}:
